...
class UpdatePersonalDetails extends Component {
    ...
    updateCustomer(e) {
        ...
        if (this.validate()) {
            userAction.updatePersonalDetails(this.props.match.params.userId, payload);
        }
    ...
    render() {
        ...
        if(isUpdatedPersonalDetails){
            return <Redirect to={`/home/${personalDetails.userId}/personalDetails`}/>
        }
        return (
                            ...
                            <div className="container">
                                <div className="container bg-dark text-light personal-details-container shadow-lg">
                                    ...
                                    <div className="row personal-details">
                                        ...
                                        <div className="col-sm-8 text-details">
                                            <div className="row">
                                                ...
                                                <span className="h2-personal-details person-name-update text-danger">{this.state.errors.userName}</span>
                                            </div>
                                        ...
                                        <div className="col-sm-8 address-text">
                                            ...
                                            <div className="row details-control">
                                                ...
                                                <div className="col-sm-5 span-personal-details">
                                                    ...
                                                    <span className="span-personal-details text-danger">{this.state.errors.pincode}</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div className="row">
                                        ...
                                        <div className="col-sm-3 buttons-update"><Link className="btn btn-danger" to={`/home/${personalDetails.userId}/personalDetails`}>Cancel</Link></div>
                                    </div>
                                </div>
                            </div>
                        </form>
...
function mapStateToProps(state) {
    return {
        ...
        personalDetailsUpdate: state.UserReducers.personalDetailsUpdate,
        isUpdatedPersonalDetails: state.UserReducers.isUpdatedPersonalDetails
...
export default connect(mapStateToProps, mapDispatchToProps)(UpdatePersonalDetails);