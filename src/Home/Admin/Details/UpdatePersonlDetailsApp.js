...
class UpdatePersonalDetails extends Component {
    ...
    componentDidMount() {
        ...
        adminAction.fetchPersonalDetails(match.params.userId);
    }
    ...
    updateCustomer(e) {
        ...
        if(this.validate()){
            adminAction.updatePersonalDetails(this.props.match.params.userId, payload);
        }
    ...
    render() {
        ...
        if(isUpdatedPersonalDetails){
            return(<Redirect to={`/admin/home/${personalDetails.userId}/personalDetails`}/>)
        }
        return (
                            ...
                            <div className="container">
                                <div className="container bg-dark text-light personal-details-container shadow-lg">
                                    ...
                                    <div className="row">
                                            ...
                                            <div className="col-sm-3 buttons-update"><Link className="btn btn-danger" to={`/admin/home/${personalDetails.userId}/personalDetails`}>Cancel</Link></div>
                                    </div>
                                </div>
                            </div>
                        </form>
